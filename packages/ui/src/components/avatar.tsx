...
function Avatar({
	...
	return (
		<AvatarPrimitive.Root
			...
			data-size={size}
			className={cn(
				"group/avatar relative flex size-8 shrink-0 rounded-full select-none after:absolute after:inset-0 after:rounded-full after:border after:border-border after:mix-blend-darken data-[size=lg]:size-10 data-[size=xl]:size-16 data-[size=sm]:size-6 data-[size=xs]:size-5 dark:after:mix-blend-lighten data-[size=xs]:after:rounded-md",
				className,
			)}
			{...props}
		/>
