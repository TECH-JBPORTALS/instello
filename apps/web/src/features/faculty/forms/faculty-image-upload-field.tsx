...
import { FACULTY_IMAGE_MAX_BYTES } from "../lib/upload-faculty-image";
import { getFacultyInitials } from "./shared-form";

type FacultyImageUploadFieldProps = {
	id: string;
	firstName: string;
	lastName: string;
	file?: File | null;
...
export function FacultyImageUploadField({
	id,
	firstName,
	lastName,
	file,
	...
	const handleFileSelect = (file: File | undefined) => {
		...
		if (file.size > FACULTY_IMAGE_MAX_BYTES) {
	...
	return (
		<Field data-invalid={isInvalid || !!fileError}>
			...
			<div
				data-slot="faculty-avatar-wrapper"
